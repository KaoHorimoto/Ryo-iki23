...
canvas.create_line(neck_x-900, neck_y, right_shoulder_x-900, right_shoulder_y, fill = "red", width=2)
canvas.create_line(neck_x-900, neck_y, left_shoulder_x-900, left_shoulder_y, fill = "red", width=2)
